    ...
    <DropdownMenu modal={false}>
      ...
      <DropdownMenuContent align="end">
        {Object.keys(themeClasses).map((themeName) => (
          <DropdownMenuItem key={themeName} onClick={() => handleThemeChange(themeName as Theme)}>
            {themeClasses[themeName as Theme]} {themeName.replace("colorblind-", "").replace("-", " ").replace(/^\w/, (c) => c.toUpperCase())}
          </DropdownMenuItem>
        ))}
      </DropdownMenuContent>
    </DropdownMenu>
