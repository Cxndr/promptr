				...
				<div className="relative max-w-5xl bg-background/80 px-8 py-5 mx-4 flex flex-col justify-center items-center rounded-3xl shadow-md shadow-black z-10">
					...
					<div className="flex flex-col gap-4">
						...
						<div className="flex gap-4 justify-center p-2">
							<Button className="bg-blue-500 hover:bg-blue-500 cursor-default text-white shadow-sm shadow-themeshadow">
								Unique words
							</Button>
							<Button className="bg-orange-500 hover:bg-orange-500 cursor-default text-white shadow-sm shadow-themeshadow">
								Filler words
							</Button>
						</div>

						<p>
							Unique words can only be used once. Filler words can be used
							multiple times.
						</p>

						<p>
							Try and come up with the best answer to the prompt with the words
							you are given.
							<br />
							<span className="text-faded-light">
								If you come up with something good submit it for other
								user&apos;s to see!
							</span>
						</p>
						...
						<p>
							...
							<br />
							<span className="text-faded-light">
								The best voted respones are displayed at the top of each prompt
								page.
							</span>
						</p>
