...
export default async function PlayPage() {
  ...
  return (
    <>
      ...
      <div className="w-[80svw] sm:w-[30svw] max-w-7xl bg-background/80 py-8 my-auto m-4 flex flex-col gap-8 justify-center items-center rounded-3xl shadow-md shadow-black z-10">
